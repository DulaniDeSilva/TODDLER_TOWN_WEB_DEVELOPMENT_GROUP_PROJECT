...
import { deleteAcademicStaff } from '../../../api';
...
function Information() {
    ...
    const handleAddFormSubmit = async (e) => {
        e.preventDefault();
        try {
            await axios.post(`${STAFF_ENDPOINT}/academic/add`, formData);
    ...
    const handleDeleteFormSubmit = async (e) => {
        ...
        try {
            ...
            window.alert(response); // Show the success message from the API response
        } catch (error) {
