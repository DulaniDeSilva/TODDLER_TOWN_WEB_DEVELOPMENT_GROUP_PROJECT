...
function LessonPlans() {
    ...
    const handleTrackingDataSubmission = (index, data) => {
        console.log("Submitting Tracking Data for lesson", index); 
    ...
    return (
        <div className="lesson-plans-container">
            ...
            {!showForm && <button className="main-tab" onClick={() => setShowForm(true)}>Add Lesson Plan</button>}
...
{!showTracking && <button className="main-tab" onClick={() => setShowTracking(true)}>Lesson Plan Tracking</button>}
            {showTracking && (
                <div>
                    <h3>Lesson Plan Tracking</h3>
                    <label>Select Month: </label>
