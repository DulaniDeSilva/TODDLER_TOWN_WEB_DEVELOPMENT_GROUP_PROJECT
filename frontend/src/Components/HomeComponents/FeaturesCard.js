    ...
    <div class = "featurescard">
       ...
       <Container className= "featurecontainer">
        <Row className='featurerow'>
            ...
            <FontAwesomeIcon icon = {faHeart} className='features-icons'></FontAwesomeIcon>
              <h3> Love</h3>
            ...
            <Col md = {3} className='featurecolumn'>
            <FontAwesomeIcon icon = {faShield} className='features-icons'></FontAwesomeIcon>
            <h3> Secure</h3>
            ...
            <Col md = {3} className='featurecolumn'>
            <FontAwesomeIcon icon = {faChild} className='features-icons'></FontAwesomeIcon>
            <h3> Care</h3>
              <p>"Our care covers it all: meals, activities, and personalized attention for your child's growth and happiness."</p>
            </Col>
            <Col md = {3} className='featurecolumn'>
            <FontAwesomeIcon icon = {faSmile} className='features-icons'></FontAwesomeIcon>
            <h3> Friendly</h3>
